...
MM_PV=$(get_version_component_range '1-3')
LM_PV=$(get_version_component_range 4-)
MY_PV="${MM_PV}-ext${LM_PV}"

DESCRIPTION="Very Secure FTP Daemon written with speed, size and security in
mind"
HOMEPAGE="http://vsftpd.devnet.ru/rus"
SRC_URI="http://vsftpd.devnet.ru/files/${MM_PV}/ext.${LM_PV}/vsftpd-${MY_PV}.tar.gz"
RESTRICT="mirror"
...
src_unpack() {
	...
	#UTF-8 switch patch for utf-8 systems
